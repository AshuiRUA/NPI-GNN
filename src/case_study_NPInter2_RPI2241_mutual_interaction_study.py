...
if __name__ == "__main__":
    ...
    # 开始挨个预测
    for interaction_key in set_interactionKey_mutual:
        # 对应的相互作用实例
        interaction_temp = dict_interactionKey_interaction[interaction_key]
        lncRNA_name = interaction_temp.lncRNA.name
        protein_name = interaction_temp.protein.name
        # 打印要预测的case的名字
        ...
        set_interactionKey_cannotUse.add(interaction_key)
