...
class Net_small(torch.nn.Module):
    def __init__(self, num_node_features, num_of_classes):
...
# lncRNA_1 = LncRNA('AC005586.2', 0, 'LncRNA')
# protein_1 = Protein('Q01844', 1, 'Protein')
# interaction_1 = LncRNA_Protein_Interaction(lncRNA_1, protein_1, True)
# print(interaction_1.lncRNA.name)
# print(interaction_1.protein.name)

# print(id(lncRNA_1))
# print(id(interaction_1.lncRNA))
